...
def setup_args_parser():
    ...
    parser.add_argument('-ad', action='append', required=False, dest='authData', help='authData is used for additional authorization')
...
if __name__ == '__main__':
    ...
    try:
        ...
        #print(type(args.authData[0]))
        #print(args.authData[0])

        #print(type(args.characteristics))
        ...
        results = pairing.put_characteristics(characteristics, args.authData[0],  do_conversion=True)
    except Exception as e:
        print(e)
        logging.debug(e, exc_info=True)
        sys.exit(-1)
