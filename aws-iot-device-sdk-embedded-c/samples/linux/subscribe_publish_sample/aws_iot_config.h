...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a1c6lndnaz78tk-ats.iot.ap-northeast-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              443 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "AWSIoTLight" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "AWSIoTLight" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "AmazonRootCA1.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "134b240ff6-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "134b240ff6-private.pem.key" ///< Device private key filename
// =================================================
